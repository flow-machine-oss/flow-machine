...
export const deleteIssueFieldInstanceIntegrationUseCase = async (
  ctx: Ctx,
  { issueId, fieldInstanceId, integrationId, organizationId }: Payload,
) => {
  ...
  return ResultAsync.fromPromise(
    ctx.db
      .delete(issueFieldInstanceIntegrationTable)
      .where(
        and(
