...
} from "@/v2/api/module/git-repository/v1/http-dto";
...
import type { GitRepositoryCrudService } from "@/v2/core/domain/git-repository/crud-service";
import type { GitRepositoryEntity } from "@/v2/core/domain/git-repository/entity";
