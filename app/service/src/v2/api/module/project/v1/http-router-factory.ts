...
} from "@/v2/api/module/project/v1/http-dto";
...
import type { ProjectCrudService } from "@/v2/core/domain/project/crud-service";
import type { ProjectEntity } from "@/v2/core/domain/project/entity";
