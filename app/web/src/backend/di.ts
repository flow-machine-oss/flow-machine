...
import { makeCredentialHttpClient } from "@/backend/http-client/credential/credential-http-client";
import { makeGitRepositoryHttpClient } from "@/backend/http-client/git-repository/git-repository-http-client";
import { makeProjectHttpClient } from "@/backend/http-client/project/project-http-client";
...
import { makeCredentialRouteHandler } from "@/backend/http-route-handler/credential/credential-route-handler";
import { makeGitRepositoryRouteHandler } from "@/backend/http-route-handler/git-repository/git-repository-route-handler";
import { makeProjectRouteHandler } from "@/backend/http-route-handler/project/project-route-handler";
...
const credentialHttpClient = makeCredentialHttpClient({
  httpClient: defaultHttpClient,
});

export const credentialRouteHandler = makeCredentialRouteHandler({
  credentialHttpClient,
});

const projectHttpClient = makeProjectHttpClient({
  httpClient: defaultHttpClient,
});

export const projectRouteHandler = makeProjectRouteHandler({
  projectHttpClient,
});
